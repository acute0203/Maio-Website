    ...
    >
      <div className="mx-auto w-5/6 justify-center text-center lg:w-4/5 xl:w-[806px]">
        ...
        <div className="w-full text-primary">
          <p className="mb-3 text-[26px] font-bold leading-9">
            鏈結未來，一步一里，編織智慧新世界
          </p>
          <p className="mx-auto w-1/2 text-sm tracking-wider">
            Chain the Future, One Mile, One Footprint,
            <br /> Weaving a World of Intelligent Technology
          </p>
        </div>
        <div className="my-12 text-start text-lg leading-8 tracking-wider text-primary">
        ...
        <div className="grid lg:grid-cols-3">
          ...
          <div className="flex flex-col items-center justify-between">
            ...
            <div className="font-bold leading-6 text-primary">
              極具豐厚獎勵與福利
              <br />
              &nbsp;
            </div>
